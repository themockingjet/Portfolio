...
export function Introduction() {
	return (
		<section className="px-6 max-h-screen h-screen text-white bg-moonstone dark:bg-dark-blue">
			<div className="flex flex-col space-y-10 h-full justify-center items-center">
				<div className="flex flex-col">
					...
					<h1 className="text-4xl w-full font-black tracking-tight text-dark-blue dark:text-moonstone">
						Jet Joseph.
					</h1>
				...
				<div className="flex space-x-5 self-start">
					<FontAwesomeIcon size="3x" icon={faSquareGithub} className="text-dark-blue dark:text-moonstone" />
					<FontAwesomeIcon size="3x" icon={faLinkedin} className="text-dark-blue dark:text-moonstone" />
					<FontAwesomeIcon size="3x" icon={faFacebook} className="text-dark-blue dark:text-moonstone" />
				</div>
			</div>
		</section>
	);
