            ...
            >
                ...
                <div className="flex flex-col space-y-6">
                    <MotionDivReveal transition={{ duration: 0.5, delay: 0 }}>
                        ...
                        industry, from Web Development to IT Operations Specialist. However, I realized that my true passion
                        lies in web development.
                    </MotionDivReveal>
                    <MotionDivReveal transition={{ duration: 0.5, delay: 0 }}>
                        Fast-forward to today, I've been learning and building projects to improve my skills in back-end and
                        front-end development. I'm currently looking for opportunities to work with other passionate
                        developers.
                    </MotionDivReveal>
                    <MotionDivReveal transition={{ duration: 0.5, delay: 0 }}>
